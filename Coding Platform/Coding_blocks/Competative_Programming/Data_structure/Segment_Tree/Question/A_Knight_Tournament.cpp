...
struct SegTree{
    ...
    void rupdate(const int l,const int r,const int s,const int e,int id,const int w)
    {
        ll rg=e-s+1;
        ...
        ll mid=(s+e)/2;
        rupdate(l,r,s,mid,2*id,w);
        rupdate(l,r,mid+1,e,2*id+1,w);
    ...
    node query(int id,const int l,const int r,const int s,const int e){
        ...
        else
        {
            ll mid=(s+e)/2;
            if(l<=mid)
                return query(2*id,l,r,s,mid);
            else 
                return query(2*id+1,l,r,mid+1,e);
        } 
        // return  + query(2*id+1,l,r,(s+e)/2+1,e);
