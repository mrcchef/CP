...
//                 if(a.arr[i]<b.arr[j])
//                 {
//                     if(!res.arr.empty() && res.arr.back()==a.arr[i])
//                         i++;
//                     else
//                         res.arr.pb(a.arr[i++]);
//                 }
//                 else
//                 {
//                     if(!res.arr.empty() && res.arr.back()==b.arr[j])
//                         j++;
//                     else
//                         res.arr.pb(b.arr[j++]);
//                 }
...
//     }
//     void build(int id,int s,int e,vi& ele)
//     {
//         if(s>e)
//             return;
...
//         build(2*id,s,mid,ele);
//         build(2*id+1,mid+1,e,ele);
...
void solve()
{
    ...
    MosAlgo mosAlgo(q,query,arr);

    vi ans=mosAlgo.mos(query);
