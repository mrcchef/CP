...
void findPredSuc(treeNode* root,treeNode* &pred,treeNode* &suc,treeNode* key)
{
    if(root==NULL)
        return ;
...
void solve()
{
    ...
    treeNode *key=new treeNode(15);

    treeNode *pred,*succ;
    findPredSuc(root,pred,succ,key);
