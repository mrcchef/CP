...
bool helper(treeNode* left,treeNode* right)
{
    ...
    if(left->data==right->data && helper(left->left,right->right) && helper(left->right,right->left))
        return true;
...
bool isSymmetricIterative(treeNode *root)
{
    ...
    while(!st.empty())
    {
        ...
        if(lnode!=NULL && rnode!=NULL && rnode->data!=lnode->data)
            return false;
...
void solve()
{
    ...
    cout<<"Is symmetrical recurssive:";
    cout<<isSymmetric(root)<<endl;

    cout<<"Is symmetrical Iterative:";
