...
// There also exist a brute force which is O(n^2) 
// which involve for printing pariticular level for a tree one by one  
void levelOrderSpiral(tree *root)
{
    // st1 is for printing left to right
    // st2 id for printing right to left
    stack<tree*> st1,st2;
