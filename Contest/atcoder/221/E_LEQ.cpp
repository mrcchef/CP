...
ll getInv(ll num,ll m)
{
    return fxp(num,m-2,m);
}
...
void solve()
{
    ...
    {   
        ...
        // debug(in);
        ll tans=fn.rsum(in+1,n);
        fn.update(in,fxp(2,in,MOD1));
        ll den=fxp(2,in+1,MOD1);
        // debug(mp(tans,den));
        ans=msum(ans,mpro(tans,getInv(den,MOD1),MOD1),MOD1);
        // debug(ans);
    }
